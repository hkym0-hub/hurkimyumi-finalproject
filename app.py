...
st.set_page_config(page_title="오늘의 추천 메뉴", page_icon="", layout="wide", initial_sidebar_state="expanded")
...
# ── 메인 영역 제목 ────────────────────────────────────────────
st.markdown('<div class="title-pill-wrap"><div class="title-pill"> 오늘의 추천 메뉴</div></div>', unsafe_allow_html=True)
...
with tab_analysis:
    ...
    if len(st.session_state.history) >= 3:
        ...
        with c3:
            ...
            type_emoji = {"밥": "", "면": "", "고기": "", "기타": ""}.get(top_type, "")
            st.markdown(f"""<div class="info-card" style="text-align:center">
