...
붙여넣은 텍스트 (1)(13).txt
문서
여기서 음식 결과가 나올때마다 히스토리에 기록되잖아, 이거 이렇게 하지 말고 내가 이 음식을 채택해야지만 히스토리에 올라가는걸로 해줘


붙여넣은 텍스트 (1)(14).txt
문서
여기서 내가 메뉴를 선택한 후에 채택하는게 아니라 결과 바로 밑에 채택 버튼 나오게 해줘
...
if st.button("🎲 랜덤 메뉴 뽑기"):
    st.session_state.random_result = random.choice(menus)

# 결과 표시
if st.session_state.get("random_result"):
    result = st.session_state.random_result

    result_card(result, "🎲 랜덤 추천 결과")

    # 👇 결과 바로 밑에 채택 버튼
    if st.button("✅ 이 메뉴 채택하기", key="accept_random"):
        add_history(result, "🎲 랜덤")
        st.success("히스토리에 저장됐어요!")
핵심은:

add_history(...)
를 결과 생성 직후가 아니라

if st.button("✅ 이 메뉴 채택하기"):
안으로 옮기는 거야.
...
결과 카드 아래에만 ✅ 채택하기 버튼 추가

모든 추천 모드에 동일하게 적용

까지 전부 반영해서 수정된 전체 app.py 파일 형태로 다시 줄게.


위에 올려놓았잖아

수정 완료된 최신 버전은 2026-05-26 15:09 파일이야.
그 파일 내용 그대로 app.py로 저장하면 돼.
...
✅ 채택하기 버튼 표시
이 줄이 그냥 코드에 그대로 들어가서 생긴 오류야.
파이썬에서는 저런 문장을 반드시 주석 처리해야 해.
...
# ✅ 채택하기 버튼 표시
아마 파일 안에 이런 식으로 들어가 있는 부분들 있을 거야:
...
# 결과 표시
if st.session_state.get("random_result"):
안 그러면 파이썬이 일반 문장을 코드로 읽어서 SyntaxError 남.


그러면 처음부터 나한테 줄땨 그렇게 줬어야지!!

맞아. 내가 설명용 문장을 코드처럼 섞어서 준 건 잘못이었어.
실행 가능한 상태로 바로 붙여넣을 수 있게 줬어야 했는데 그렇게 안 된 거고, 네가 오류 난 거 당연해.

앞으로는 설명 문장 없이 실행 가능한 코드만 따로 줄게.


에러 수정한 전체 파일을 줘

지금 네 파일에서 에러 없이 돌아가는 기준 최신본은 이 파일이야:


붙여넣은 텍스트 (1).txt
문서
그리고 반드시 아래처럼 되어 있어야 정상 실행됨:
...
def adopt_button(menu, method, key_suffix=""):
    ...
    with col2:
        if st.button(
            "✅ 이 메뉴로 결정!",
            key=f"adopt_{key_suffix}",
            use_container_width=True,
            type="primary"
        ):
            add_history(menu, method)
            st.success(
                f"🎉 **{menu['name']}** 이(가) 오늘의 메뉴로 기록됐어요!"
            )
            st.rerun()
그리고 네 파일 안에 아래처럼 “설명 문장”이 단독으로 들어가 있으면 전부 삭제해야 해:
...
MENU_DATA = {
"저녁 메뉴": [
{"name":"삼겹살","cal":700,"emoji":"🥓","food_type":"고기","delivery","budget":"중"},
{"name":"치킨","cal":850,"emoji":"🍗","food_type":"고기","delivery","budget":"중"},
{"name":"피자","cal":900,"emoji":"🍕","food_type":"기타","delivery","budget":"중"},
{"name":"파스타","cal":650,"emoji":"🍝","food_type":"면","delivery","budget":"중"},
{"name":"스테이크","cal":800,"emoji":"🥩","food_type":"고기","delivery","budget":"고"},
{"name":"초밥","cal":500,"emoji":"🍣","food_type":"기타","delivery","budget":"고"},
{"name":"된장찌개","cal":350,"emoji":"🍲","food_type":"밥","delivery","budget":"저"},
{"name":"갈비탕","cal":600,"emoji":"🍖","food_type":"고기","delivery","budget":"중"},
{"name":"불고기","cal":550,"emoji":"🔥","food_type":"고기","delivery","budget":"중"},
{"name":"쭈꾸미볶음","cal":450,"emoji":"🐙","food_type":"기타","delivery","budget":"저"},
{"name":"순두부찌개","cal":300,"emoji":"🫕","food_type":"밥","delivery","budget":"저"},
{"name":"부대찌개","cal":650,"emoji":"🍲","food_type":"밥","delivery","budget":"저"},
{"name":"곱창전골","cal":700,"emoji":"🫕","food_type":"고기","delivery","budget":"중"},
{"name":"닭갈비","cal":580,"emoji":"🍗","food_type":"고기","delivery","budget":"저"},
],
"배달 메뉴": [
{"name":"치킨","cal":850,"emoji":"🍗","food_type":"고기","delivery","budget":"중"},
{"name":"피자","cal":900,"emoji":"🍕","food_type":"기타","delivery","budget":"중"},
{"name":"짜장면","cal":650,"emoji":"🍜","food_type":"면","delivery","budget":"저"},
{"name":"짬뽕","cal":700,"emoji":"🍜","food_type":"면","delivery","budget":"저"},
{"name":"떡볶이","cal":500,"emoji":"🌶️","food_type":"기타","delivery","budget":"저"},
{"name":"족발","cal":750,"emoji":"🍖","food_type":"고기","delivery","budget":"중"},
{"name":"버거","cal":650,"emoji":"🍔","food_type":"기타","delivery","budget":"저"},
{"name":"마라탕","cal":700,"emoji":"🥢","food_type":"기타","delivery","budget":"중"},
{"name":"초밥 세트","cal":520,"emoji":"🍣","food_type":"기타","delivery","budget":"고"},
{"name":"국밥","cal":550,"emoji":"🍲","food_type":"밥","delivery","budget":"저"},
{"name":"쌀국수","cal":480,"emoji":"🍜","food_type":"면","delivery","budget":"저"},
{"name":"보쌈","cal":680,"emoji":"🥬","food_type":"고기","delivery","budget":"중"},
{"name":"감자탕","cal":620,"emoji":"🍲","food_type":"고기","delivery","budget":"저"},
{"name":"샌드위치","cal":450,"emoji":"🥪","food_type":"기타","delivery","budget":"저"},
],
"데이트 메뉴": [
{"name":"파스타","cal":650,"emoji":"🍝","food_type":"면","delivery","budget":"중"},
{"name":"스테이크","cal":800,"emoji":"🥩","food_type":"고기","delivery","budget":"고"},
{"name":"초밥 / 오마카세","cal":600,"emoji":"🍣","food_type":"기타","delivery","budget":"고"},
{"name":"샤브샤브","cal":450,"emoji":"🍲","food_type":"기타","delivery","budget":"고"},
{"name":"와인 파스타","cal":700,"emoji":"🍷","food_type":"면","delivery","budget":"고"},
{"name":"리조또","cal":620,"emoji":"🍚","food_type":"밥","delivery","budget":"고"},
{"name":"프렌치 코스","cal":900,"emoji":"🥂","food_type":"기타","delivery","budget":"고"},
{"name":"타파스","cal":500,"emoji":"🫒","food_type":"기타","delivery","budget":"고"},
{"name":"훠궈","cal":750,"emoji":"🫕","food_type":"기타","delivery","budget":"중"},
{"name":"브런치 카페","cal":550,"emoji":"☕","food_type":"기타","delivery","budget":"중"},
{"name":"이탈리안 뷔페","cal":850,"emoji":"🍽️","food_type":"기타","delivery","budget":"고"},
{"name":"스시 오마카세","cal":700,"emoji":"🍱","food_type":"기타","delivery","budget":"고"},
],
"다이어트 메뉴": [
{"name":"닭가슴살 샐러드","cal":280,"emoji":"🥗","food_type":"기타","delivery","budget":"저"},
{"name":"두부 스테이크","cal":200,"emoji":"🥩","food_type":"기타","delivery","budget":"저"},
{"name":"곤약 비빔밥","cal":250,"emoji":"🍚","food_type":"밥","delivery","budget":"저"},
{"name":"그릭 요거트 볼","cal":180,"emoji":"🥣","food_type":"기타","delivery","budget":"저"},
{"name":"채소 스프","cal":120,"emoji":"🥦","food_type":"기타","delivery","budget":"저"},
{"name":"연어 포케","cal":380,"emoji":"🐟","food_type":"기타","delivery","budget":"중"},
{"name":"닭가슴살 도시락","cal":300,"emoji":"🍱","food_type":"고기","delivery","budget":"저"},
{"name":"오트밀 볼","cal":220,"emoji":"🌾","food_type":"기타","delivery","budget":"저"},
{"name":"현미 잡곡밥 정식","cal":420,"emoji":"🍚","food_type":"밥","delivery","budget":"저"},
{"name":"저칼로리 김밥","cal":320,"emoji":"🍙","food_type":"기타","delivery","budget":"저"},
{"name":"채소 쌈밥","cal":350,"emoji":"🥬","food_type":"밥","delivery","budget":"저"},
{"name":"토마토 달걀볶음","cal":200,"emoji":"🍳","food_type":"기타","delivery","budget":"저"},
{"name":"닭가슴살 볶음밥","cal":380,"emoji":"🍳","food_type":"밥","delivery","budget":"저"},
],
"가성비 메뉴": [
{"name":"김밥","cal":400,"emoji":"🍙","food_type":"기타","delivery","budget":"저"},
{"name":"순대국밥","cal":550,"emoji":"🍲","food_type":"밥","delivery","budget":"저"},
{"name":"라면","cal":500,"emoji":"🍜","food_type":"면","delivery","budget":"저"},
{"name":"백반","cal":650,"emoji":"🍚","food_type":"밥","delivery","budget":"저"},
{"name":"편의점 도시락","cal":550,"emoji":"🏪","food_type":"밥","delivery","budget":"저"},
{"name":"분식 세트","cal":600,"emoji":"🌶️","food_type":"기타","delivery","budget":"저"},
{"name":"컵라면 + 삼각김밥","cal":450,"emoji":"🍙","food_type":"면","delivery","budget":"저"},
{"name":"뼈다귀해장국","cal":500,"emoji":"🍲","food_type":"밥","delivery","budget":"저"},
{"name":"돈까스 정식","cal":700,"emoji":"🥩","food_type":"고기","delivery","budget":"저"},
{"name":"제육볶음 백반","cal":650,"emoji":"🍳","food_type":"밥","delivery","budget":"저"},
{"name":"칼국수","cal":520,"emoji":"🍜","food_type":"면","delivery","budget":"저"},
{"name":"콩나물국밥","cal":400,"emoji":"🍲","food_type":"밥","delivery","budget":"저"},
{"name":"떡볶이 + 순대","cal":580,"emoji":"🌶️","food_type":"기타","delivery","budget":"저"},
],
"캠핑 메뉴": [
{"name":"삼겹살 구이","cal":700,"emoji":"🔥","food_type":"고기","delivery","budget":"저"},
{"name":"라면","cal":500,"emoji":"🍜","food_type":"면","delivery","budget":"저"},
{"name":"핫도그","cal":380,"emoji":"🌭","food_type":"기타","delivery","budget":"저"},
{"name":"불고기","cal":550,"emoji":"🥩","food_type":"고기","delivery","budget":"중"},
{"name":"옥수수 구이","cal":180,"emoji":"🌽","food_type":"기타","delivery","budget":"저"},
{"name":"감자 구이","cal":200,"emoji":"🥔","food_type":"기타","delivery","budget":"저"},
{"name":"부대찌개","cal":650,"emoji":"🍲","food_type":"밥","delivery","budget":"저"},
{"name":"닭꼬치","cal":350,"emoji":"🍢","food_type":"고기","delivery","budget":"저"},
{"name":"소시지 구이","cal":400,"emoji":"🌭","food_type":"고기","delivery","budget":"저"},
{"name":"묵은지 삼겹","cal":720,"emoji":"🥓","food_type":"고기","delivery","budget":"중"},
{"name":"즉석 떡볶이","cal":480,"emoji":"🌶️","food_type":"기타","delivery","budget":"저"},
{"name":"어묵탕","cal":300,"emoji":"🍢","food_type":"기타","delivery","budget":"저"},
{"name":"스팸 구이","cal":450,"emoji":"🥫","food_type":"고기","delivery","budget":"저"},
],
"매운 메뉴": [
{"name":"불닭볶음면","cal":530,"emoji":"🔥","food_type":"면","delivery","budget":"저"},
{"name":"마라탕","cal":700,"emoji":"🌶️","food_type":"기타","delivery","budget":"중"},
{"name":"엽기 떡볶이","cal":600,"emoji":"🌶️","food_type":"기타","delivery","budget":"저"},
{"name":"매운 김치찌개","cal":400,"emoji":"🍲","food_type":"밥","delivery","budget":"저"},
{"name":"육개장","cal":350,"emoji":"🍲","food_type":"밥","delivery","budget":"저"},
{"name":"마라샹궈","cal":800,"emoji":"🥢","food_type":"기타","delivery","budget":"중"},
{"name":"불닭 피자","cal":950,"emoji":"🍕","food_type":"기타","delivery","budget":"중"},
{"name":"매운 갈비찜","cal":750,"emoji":"🍖","food_type":"고기","delivery","budget":"중"},
{"name":"낙지볶음","cal":380,"emoji":"🐙","food_type":"기타","delivery","budget":"중"},
{"name":"쭈꾸미볶음","cal":420,"emoji":"🦑","food_type":"기타","delivery","budget":"저"},
{"name":"매운 해물탕","cal":500,"emoji":"🦀","food_type":"기타","delivery","budget":"중"},
{"name":"불족발","cal":780,"emoji":"🔥","food_type":"고기","delivery","budget":"중"},
{"name":"청양 닭볶음탕","cal":600,"emoji":"🍗","food_type":"고기","delivery","budget":"저"},
],
"파티 메뉴": [
{"name":"피자","cal":900,"emoji":"🍕","food_type":"기타","delivery","budget":"중"},
{"name":"치킨","cal":850,"emoji":"🍗","food_type":"고기","delivery","budget":"중"},
{"name":"파스타 플래터","cal":700,"emoji":"🍝","food_type":"면","delivery","budget":"고"},
{"name":"타코","cal":550,"emoji":"🌮","food_type":"기타","delivery","budget":"중"},
{"name":"샌드위치 플래터","cal":600,"emoji":"🥪","food_type":"기타","delivery","budget":"중"},
{"name":"뷔페","cal":900,"emoji":"🍽️","food_type":"기타","delivery","budget":"고"},
{"name":"초밥 세트","cal":560,"emoji":"🍣","food_type":"기타","delivery","budget":"고"},
{"name":"바비큐 플래터","cal":850,"emoji":"🔥","food_type":"고기","delivery","budget":"고"},
{"name":"케이터링 도시락","cal":700,"emoji":"🍱","food_type":"밥","delivery","budget":"중"},
{"name":"나초 + 딥","cal":500,"emoji":"🫔","food_type":"기타","delivery","budget":"저"},
{"name":"핑거푸드 세트","cal":450,"emoji":"🍢","food_type":"기타","delivery","budget":"중"},
{"name":"떡 케이크","cal":400,"emoji":"🎂","food_type":"기타","delivery","budget":"중"},
],
"한식 메뉴": [
{"name":"비빔밥","cal":550,"emoji":"🍚","food_type":"밥","delivery","budget":"저"},
{"name":"된장찌개","cal":350,"emoji":"🍲","food_type":"밥","delivery","budget":"저"},
{"name":"삼겹살","cal":700,"emoji":"🥓","food_type":"고기","delivery","budget":"중"},
{"name":"불고기","cal":550,"emoji":"🥩","food_type":"고기","delivery","budget":"중"},
{"name":"냉면","cal":500,"emoji":"🍜","food_type":"면","delivery","budget":"중"},
{"name":"갈비탕","cal":600,"emoji":"🍖","food_type":"고기","delivery","budget":"중"},
{"name":"삼계탕","cal":580,"emoji":"🐔","food_type":"고기","delivery","budget":"중"},
{"name":"순대국밥","cal":550,"emoji":"🍲","food_type":"밥","delivery","budget":"저"},
{"name":"해물파전","cal":480,"emoji":"🥞","food_type":"기타","delivery","budget":"저"},
{"name":"잡채","cal":420,"emoji":"🍜","food_type":"면","delivery","budget":"중"},
{"name":"감자탕","cal":620,"emoji":"🍲","food_type":"고기","delivery","budget":"저"},
{"name":"보쌈","cal":680,"emoji":"🥬","food_type":"고기","delivery","budget":"중"},
{"name":"닭갈비","cal":580,"emoji":"🍗","food_type":"고기","delivery","budget":"저"},
{"name":"낙지볶음","cal":380,"emoji":"🐙","food_type":"기타","delivery","budget":"중"},
{"name":"떡국","cal":450,"emoji":"🍲","food_type":"밥","delivery","budget":"저"},
],
"일식 메뉴": [
{"name":"초밥","cal":500,"emoji":"🍣","food_type":"기타","delivery","budget":"고"},
{"name":"라멘","cal":700,"emoji":"🍜","food_type":"면","delivery","budget":"중"},
{"name":"우동","cal":450,"emoji":"🍜","food_type":"면","delivery","budget":"중"},
{"name":"돈카츠","cal":750,"emoji":"🥩","food_type":"고기","delivery","budget":"중"},
{"name":"오야코동","cal":600,"emoji":"🍚","food_type":"밥","delivery","budget":"중"},
{"name":"타코야키","cal":380,"emoji":"🐙","food_type":"기타","delivery","budget":"저"},
{"name":"규동","cal":620,"emoji":"🍚","food_type":"밥","delivery","budget":"저"},
{"name":"나가사키 짬뽕","cal":680,"emoji":"🍜","food_type":"면","delivery","budget":"중"},
{"name":"오마카세","cal":700,"emoji":"🍱","food_type":"기타","delivery","budget":"고"},
{"name":"야키토리","cal":400,"emoji":"🍢","food_type":"고기","delivery","budget":"중"},
{"name":"카레라이스","cal":650,"emoji":"🍛","food_type":"밥","delivery","budget":"저"},
{"name":"소바","cal":400,"emoji":"🍜","food_type":"면","delivery","budget":"중"},
{"name":"이자카야 세트","cal":750,"emoji":"🍶","food_type":"기타","delivery","budget":"고"},
],
"양식 메뉴": [
{"name":"파스타","cal":650,"emoji":"🍝","food_type":"면","delivery","budget":"중"},
{"name":"피자","cal":900,"emoji":"🍕","food_type":"기타","delivery","budget":"중"},
...
{"name":"버거","cal":650,"emoji":"🍔","food_type":"기타","delivery","budget":"저"},
{"name":"리조또","cal":620,"emoji":"🍚","food_type":"밥","delivery","budget":"고"},
{"name":"샐러드","cal":250,"emoji":"🥗","food_type":"기타","delivery","budget":"중"},
{"name":"그라탱","cal":700,"emoji":"🧀","food_type":"기타","delivery","budget":"중"},
{"name":"크림 수프","cal":350,"emoji":"🍵","food_type":"기타","delivery","budget":"중"},
{"name":"연어 스테이크","cal":550,"emoji":"🐟","food_type":"고기","delivery","budget":"고"},
{"name":"브런치 플레이트","cal":600,"emoji":"🥞","food_type":"기타","delivery","budget":"중"},
{"name":"함박스테이크","cal":680,"emoji":"🥩","food_type":"고기","delivery","budget":"중"},
{"name":"치킨 알프레도","cal":720,"emoji":"🍝","food_type":"면","delivery","budget":"중"},
{"name":"클램 차우더","cal":380,"emoji":"🍵","food_type":"기타","delivery","budget":"중"},
],
"중식 메뉴": [
{"name":"짜장면","cal":650,"emoji":"🍜","food_type":"면","delivery","budget":"저"},
{"name":"짬뽕","cal":700,"emoji":"🍜","food_type":"면","delivery","budget":"저"},
{"name":"탕수육","cal":800,"emoji":"🥩","food_type":"고기","delivery","budget":"중"},
{"name":"마파두부","cal":400,"emoji":"🌶️","food_type":"밥","delivery","budget":"중"},
{"name":"딤섬","cal":500,"emoji":"🥟","food_type":"기타","delivery","budget":"중"},
{"name":"마라탕","cal":700,"emoji":"🥢","food_type":"기타","delivery","budget":"중"},
{"name":"마라샹궈","cal":800,"emoji":"🌶️","food_type":"기타","delivery","budget":"중"},
{"name":"훠궈","cal":750,"emoji":"🫕","food_type":"기타","delivery","budget":"고"},
{"name":"꿔바로우","cal":820,"emoji":"🥩","food_type":"고기","delivery","budget":"중"},
{"name":"양꼬치","cal":600,"emoji":"🍢","food_type":"고기","delivery","budget":"중"},
{"name":"깐풍기","cal":780,"emoji":"🍗","food_type":"고기","delivery","budget":"중"},
{"name":"유린기","cal":700,"emoji":"🍗","food_type":"고기","delivery","budget":"중"},
{"name":"동파육","cal":850,"emoji":"🥩","food_type":"고기","delivery","budget":"고"},
],
"안주 메뉴": [
{"name":"치킨","cal":850,"emoji":"🍗","food_type":"고기","delivery","budget":"중"},
{"name":"족발","cal":750,"emoji":"🍖","food_type":"고기","delivery","budget":"중"},
{"name":"마른안주 세트","cal":300,"emoji":"🦑","food_type":"기타","delivery","budget":"저"},
{"name":"두부김치","cal":350,"emoji":"🥬","food_type":"기타","delivery","budget":"저"},
{"name":"골뱅이소면","cal":450,"emoji":"🐌","food_type":"면","delivery","budget":"저"},
{"name":"감자전","cal":380,"emoji":"🥞","food_type":"기타","delivery","budget":"저"},
{"name":"해물파전","cal":480,"emoji":"🥞","food_type":"기타","delivery","budget":"저"},
{"name":"닭발","cal":420,"emoji":"🍗","food_type":"고기","delivery","budget":"저"},
{"name":"삼겹살","cal":700,"emoji":"🥓","food_type":"고기","delivery","budget":"중"},
{"name":"소시지 야채볶음","cal":500,"emoji":"🌭","food_type":"고기","delivery","budget":"저"},
{"name":"계란말이","cal":280,"emoji":"🥚","food_type":"기타","delivery","budget":"저"},
{"name":"오돌뼈","cal":460,"emoji":"🦴","food_type":"고기","delivery","budget":"저"},
{"name":"곱창볶음","cal":650,"emoji":"🫕","food_type":"고기","delivery","budget":"중"},
{"name":"라볶이","cal":550,"emoji":"🌶️","food_type":"기타","delivery","budget":"저"},
],
"혼자 먹는 메뉴": [
{"name":"편의점 도시락","cal":550,"emoji":"🏪","food_type":"밥","delivery","budget":"저"},
{"name":"라면","cal":500,"emoji":"🍜","food_type":"면","delivery","budget":"저"},
{"name":"김밥 한 줄","cal":400,"emoji":"🍙","food_type":"기타","delivery","budget":"저"},
{"name":"우동","cal":450,"emoji":"🫕","food_type":"면","delivery","budget":"저"},
{"name":"덮밥","cal":600,"emoji":"🍚","food_type":"밥","delivery","budget":"저"},
{"name":"국밥","cal":550,"emoji":"🍲","food_type":"밥","delivery","budget":"저"},
{"name":"냉면","cal":500,"emoji":"🍜","food_type":"면","delivery","budget":"중"},
{"name":"돈까스 정식","cal":700,"emoji":"🥩","food_type":"고기","delivery","budget":"저"},
{"name":"1인 샤브샤브","cal":480,"emoji":"🍲","food_type":"기타","delivery","budget":"중"},
{"name":"제육 덮밥","cal":620,"emoji":"🍳","food_type":"밥","delivery","budget":"저"},
{"name":"삼각김밥 세트","cal":420,"emoji":"🍙","food_type":"기타","delivery","budget":"저"},
{"name":"소고기 국밥","cal":580,"emoji":"🍲","food_type":"밥","delivery","budget":"저"},
{"name":"짬뽕 1인분","cal":680,"emoji":"🍜","food_type":"면","delivery","budget":"저"},
{"name":"혼밥 정식","cal":650,"emoji":"🍱","food_type":"밥","delivery","budget":"저"},
],
}
...
── 제목 ─────────────────────────────────────────────────────
st.markdown('🍽️ 오늘의 추천 메뉴', unsafe_allow_html=True)
...
👉 오늘의 추천: {fortune_food['emoji']} {fortune_food['name']}


── 카테고리 탭 ──────────────────────────────────────────────
st.markdown('카테고리', unsafe_allow_html=True)
...
if nm.strip():
st.session_state.custom_menus.append({"name".strip(),"cal","emoji","food_type","budget","delivery"})
...
st.markdown(f"제외 중: {', '.join(st.session_state.excluded)}", unsafe_allow_html=True)
