...
if len(menus) < 2:
    ...
    if method == "random":
        ...
        st.markdown("<p style='text-align:center;color:#888;font-size:.85rem;margin-top:.5rem'>슬롯에서 결과 확인 후 아래 버튼으로 채택하세요</p>", unsafe_allow_html=True)
